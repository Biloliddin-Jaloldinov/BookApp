package uz.gita.book_application.data.remote.api

import retrofit2.Response
import retrofit2.http.*
import uz.gita.book_application.data.remote.request.*
import uz.gita.book_application.data.remote.response.AuthResponse
import uz.gita.book_application.data.remote.response.BookResponse
import uz.gita.book_application.data.remote.response.ErrorResponse
